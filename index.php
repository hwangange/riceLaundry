			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="claimMachine.php" method = "post">
						...
						<br><br>
						<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modalReport"
	...
	<div class="scroll-area">
		<div class="tab-content">
			<div class="tab-pane active" id="1a">
          		<div class="row">
					<div class="col-sm-12">
						<h1 id="laundrystr">laundry room</h1>
					</div>
				</div>
			...
			<div class="tab-pane" id="2a">
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1 class="title">your machines</h1>
					</div>
				</div>
				<div class="row">
      ...
      <div class="tab-pane" id="3a">
            ...
            <h1 class="title">settings</h1>
					...
					<div class="row">
						...
						<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
							<h1><script>document.write(showCurrentUsr())</script></h1>
						</div>
					</div>
					<div class="row">
						<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
					...
					<form action="/action_page.php">
							<select onchange="showCurrentCollege()" id="college" name="options" class="form-control">
								<option selected disabled>change college </option>
